...
MIDDLEWARE = [
    ...
    'taremwa.middleware.AuditActorMiddleware',
...
# For development: use console backend (outputs to console, no actual email sending)
# For production: configure with EMAIL_BACKEND, EMAIL_HOST, EMAIL_PORT, etc.
if DEBUG:
